" -----------------------------------------------------------------------------
" File: blue_teal.vim
" Description: Cool blue-slate dark theme — gruvbox-inspired structure
" Palette sourced from alacritty.toml
" -----------------------------------------------------------------------------
...
let s:bt.dark0_hard  = ['#262630', 235]   " deeper than primary bg
let s:bt.dark0       = ['#2e2e38', 236]   " primary.background
let s:bt.dark0_soft  = ['#323240', 237]   " lifted bg
let s:bt.dark1       = ['#3c3e50', 238]   " normal black — modeline, sidebars
let s:bt.dark2       = ['#484a60', 239]   " selection.background
let s:bt.dark3       = ['#525468', 59]    " hl-line, panels
let s:bt.dark4       = ['#5e6078', 60]    " panel borders / bright black

let s:bt.gray_245    = ['#6c7080', 61]    " comments, line-numbers
let s:bt.gray_244    = ['#6c7080', 61]

" Foregrounds — stepped from brightest to dimmest
let s:bt.light0_hard = ['#e0dee8', 255]   " brightest white
let s:bt.light0      = ['#d4d2e2', 189]   " primary foreground
let s:bt.light0_soft = ['#d4d2e2', 189]
let s:bt.light1      = ['#c8ccd8', 146]   " bright white / secondary fg
let s:bt.light2      = ['#b0b4c0', 146]   " dimmer fg
let s:bt.light3      = ['#9098a8', 103]   " muted fg
let s:bt.light4      = ['#8890a0', 103]   " faint / normal white

" Accent colours — spread across a wider luminosity range for clear hierarchy
let s:bt.bright_red     = ['#e05050', 203]  " errors
let s:bt.bright_green   = ['#60a068', 72]   " strings
let s:bt.bright_yellow  = ['#c0b030', 178]  " types
let s:bt.bright_blue    = ['#5890c8', 68]   " keywords
let s:bt.bright_purple  = ['#a860c8', 134]  " constants
let s:bt.bright_aqua    = ['#50a8c8', 74]   " functions
let s:bt.bright_orange  = ['#b89840', 136]  " preprocessor — warm contrast to cool palette

let s:bt.neutral_red    = ['#c04040', 167]
let s:bt.neutral_green  = ['#508858', 65]
let s:bt.neutral_yellow = ['#a09028', 136]
let s:bt.neutral_blue   = ['#4878b0', 68]
let s:bt.neutral_purple = ['#8848a8', 97]
let s:bt.neutral_aqua   = ['#3888a8', 67]
let s:bt.neutral_orange = ['#906030', 130]

let s:bt.faded_red      = ['#7a2828', 88]
let s:bt.faded_green    = ['#306040', 22]
let s:bt.faded_yellow   = ['#686018', 58]
let s:bt.faded_blue     = ['#305888', 24]
let s:bt.faded_purple   = ['#583070', 54]
let s:bt.faded_aqua     = ['#285878', 23]
let s:bt.faded_orange   = ['#705020', 94]
...
if !exists('g:rbpt_colorpairs')
  let g:rbpt_colorpairs =
    \ [
      \ ['blue', '#3a5898'], ['magenta', '#704890'],
      \ ['red',  '#904848'], ['179',     '#908040']
    \ ]
endif

let g:rainbow_guifgs = [ '#908040', '#904848', '#704890', '#3a5898' ]
let g:rainbow_ctermfgs = [ '136', '167', '97', '68' ]
